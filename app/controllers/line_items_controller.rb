class LineItemsController < ApplicationController
  ...
  def create
    ...
    if @line_item.save
      respond_to do |format|
        format.html { redirect_to @line_item_date.quote, notice: "Line item was successfully created." }
  ...
  def update
    if @line_item.update(line_item_params)
      respond_to do |format|
        format.html { redirect_to @line_item_date.quote, notice: "Line item was successfully updated." }
  ...
  def destroy
    @line_item.destroy
    respond_to do |format|
      format.html { redirect_to @line_item_date.quote, notice: "Line item was successfully destroyed." }
